...
// Start Server with Vite Middleware (apenas fora da Vercel)
...
// Na Vercel (process.env.VERCEL existe) NÃO chamamos listen/startServer:
// a Vercel importa "app" via api/index.ts e cuida do roteamento.
